  ...
  return (
    <div className="2xl:h-[calc(100vh-98px)] 2xl-to-xl:h-[calc(100vh-86px)] h-[calc(100vh-86px)] overflow-y-auto customScrollbar bg-gray-100">
      <div className="2xl:p-6 2xl-to-xl:p-4 p-4">
        ...
        {/* ━━ HEADER CONTAINER ━━ */}
        <div className="bg-white border border-gray-200 rounded-lg 2xl:p-5 2xl-to-xl:p-4 p-4 mb-4">
          ...
          {showLegend && (
            <div className="rounded-lg border border-gray-200 bg-gray-50 2xl:p-4 p-3 mb-4">
          ...
          {/* Portal tabs — sits at the bottom of the header container */}
          <div className="flex items-center gap-1 border-b border-gray-200 -mb-4 2xl:-mx-5 2xl-to-xl:-mx-4 -mx-4 2xl:px-5 2xl-to-xl:px-4 px-4">
            {brief.portals.map((p, i) => {
              ...
              return (
                <button
                  ...
                  className={`relative 2xl:px-4 px-3 2xl:py-2.5 py-2 2xl:text-sm text-xs font-medium transition-colors rounded-t-lg ${isActive
                      ? 'text-indigo-700 bg-white border-t border-x border-gray-200 -mb-px'
